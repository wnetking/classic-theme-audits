 ...
 *}
{widget_block name="ps_categoryproducts"}
  <section id="category-product-module" class="featured-products clearfix mt-3 defered-load"
      data-modulename="ps_categoryproducts">
    <h2>
      {if $products|@count == 1}
